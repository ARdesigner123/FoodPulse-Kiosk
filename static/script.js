...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // 🚨 EXIT EARLY if profile modal does not exist on this page
    if (!profileBtn || !vendorModal) return;
    ...
    if (vendorFoodCourt) {
        vendorFoodCourt.addEventListener("change", () => {
            ...
            if (!foodCourtStalls[selectedFC]) return;
